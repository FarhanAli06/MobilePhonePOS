...
public class CustomerRepository : Repository<Customer>, ICustomerRepository
{
    ...
    public async Task<IEnumerable<Customer>> GetByShopIdAsync(int shopId)
    {
        return await _dbSet
    ...
    public async Task<IEnumerable<Customer>> GetByShopAsync(int shopId, string? searchTerm = null)
    {
    ...
    public async Task<IEnumerable<Customer>> SearchAsync(int shopId, string searchTerm)
    {
        var lowerSearchTerm = searchTerm.ToLower();
