...
public class UserService : IUserService
{
    ...
    public async Task<IEnumerable<UserDto>> GetFilteredUsersAsync(UserFilterRequest filter)
    {
        ...
        {
            query = query.Where(u => u.UserShopRoles.Any(usr => usr.RoleId == filter.RoleId.Value));
        }
    ...
    public async Task<UserDto> CreateUserAsync(CreateUserRequest request, int createdByUserId)
    {
        ...
        await AssignUserToShopAsync(createdUser.Id, request.ShopId, request.RoleId);
    ...
    public async Task<UserDto> UpdateUserAsync(int id, UpdateUserRequest request, int modifiedByUserId)
    {
        ...
        await UpdateUserRoleInShopAsync(id, request.ShopId, request.RoleId);
    ...
    public async Task AssignUserToShopAsync(int userId, int shopId, int roleId)
    {
    ...
    public async Task UpdateUserRoleInShopAsync(int userId, int shopId, int roleId)
    {
        await _userRepository.UpdateUserShopRoleAsync(userId, shopId, roleId);
    }
