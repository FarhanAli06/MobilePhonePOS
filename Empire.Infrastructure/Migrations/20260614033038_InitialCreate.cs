        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RequestBody = table.Column<string>(type: "nvarchar(max)", maxLength: 4096, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BadgeVariant = table.Column<string>(type: "nvarchar(30)", maxLength: 30, nullable: false),
                    IsActive = table.Column<bool>(type: "bit", nullable: false),
                    DisplayOrder = table.Column<int>(type: "int", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: true)
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_InventoryCategories_Shops_ShopId",
                        column: x => x.ShopId,
                        principalTable: "Shops",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsActive = table.Column<bool>(type: "bit", nullable: false),
                    DisplayOrder = table.Column<int>(type: "int", nullable: false),
                    StylingId = table.Column<int>(type: "int", nullable: true),
                    CreatedDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    ModifiedDate = table.Column<DateTime>(type: "datetime2", nullable: true),
                    IsDeleted = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Brands_Stylings_StylingId",
                        column: x => x.StylingId,
                        principalTable: "Stylings",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_DeviceCategories_Shops_ShopId",
                        column: x => x.ShopId,
                        principalTable: "Shops",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_DeviceCategories_Stylings_StylingId",
                        column: x => x.StylingId,
                        principalTable: "Stylings",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_UserPagePermissions_Shops_ShopId",
                        column: x => x.ShopId,
                        principalTable: "Shops",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_UserPagePermissions_Shops_ShopId1",
                        column: x => x.ShopId1,
                        principalTable: "Shops",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_UserShopRoles_Roles_RoleId",
                        column: x => x.RoleId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    ShopId = table.Column<int>(type: "int", nullable: false, defaultValue: 0),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_LookupValues_Stylings_StylingId",
                        column: x => x.StylingId,
                        principalTable: "Stylings",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_DeviceModels_Shops_ShopId",
                        column: x => x.ShopId,
                        principalTable: "Shops",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_DeviceModels_Stylings_StylingId",
                        column: x => x.StylingId,
                        principalTable: "Stylings",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    GB = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: true),
                    ...
                    DeviceCategoryId1 = table.Column<int>(type: "int", nullable: true),
                    DeviceModelId1 = table.Column<int>(type: "int", nullable: true),
                    CreatedDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    ModifiedDate = table.Column<DateTime>(type: "datetime2", nullable: true),
                    IsDeleted = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Devices_DeviceCategories_DeviceCategoryId1",
                        column: x => x.DeviceCategoryId1,
                        principalTable: "DeviceCategories",
                        principalColumn: "Id");
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Devices_DeviceModels_DeviceModelId1",
                        column: x => x.DeviceModelId1,
                        principalTable: "DeviceModels",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DeviceCategoryId1 = table.Column<int>(type: "int", nullable: true),
                    DeviceModelId1 = table.Column<int>(type: "int", nullable: true),
                    InventoryCategoryId1 = table.Column<int>(type: "int", nullable: true),
                    CreatedDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    ModifiedDate = table.Column<DateTime>(type: "datetime2", nullable: true),
                    IsDeleted = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_InventoryItems_Brands_BrandId1",
                        column: x => x.BrandId1,
                        principalTable: "Brands",
                        principalColumn: "Id");
                    table.ForeignKey(
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_InventoryItems_DeviceCategories_DeviceCategoryId1",
                        column: x => x.DeviceCategoryId1,
                        principalTable: "DeviceCategories",
                        principalColumn: "Id");
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_InventoryItems_DeviceModels_DeviceModelId1",
                        column: x => x.DeviceModelId1,
                        principalTable: "DeviceModels",
                        principalColumn: "Id");
                    table.ForeignKey(
                    ...
                    table.ForeignKey(
                        ...
                        column: x => x.InventoryCategoryId1,
                        principalTable: "InventoryCategories",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Repairs_Users_CreatedBy",
                        column: x => x.CreatedBy,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Repairs_Users_ModifiedBy",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RepairActivities", x => x.Id);
                    table.ForeignKey(
                        name: "FK_RepairActivities_Repairs_RepairId",
                        column: x => x.RepairId,
                        principalTable: "Repairs",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_RepairActivities_Users_PerformedByUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_RepairParts_InventoryItems_InventoryItemId",
                        column: x => x.InventoryItemId,
                        principalTable: "InventoryItems",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_RepairPayments_Repairs_RepairId",
                        column: x => x.RepairId,
                        principalTable: "Repairs",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_RepairPayments_Users_CreatedBy",
                        column: x => x.CreatedBy,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsCustomItem = table.Column<bool>(type: "bit", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.SetNull);
                    table.ForeignKey(
                        name: "FK_SaleItems_Repairs_RepairId",
                        column: x => x.RepairId,
                        principalTable: "Repairs",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Categories_ShopId_Name_CategoryType",
                table: "Categories",
                columns: new[] { "ShopId", "Name", "CategoryType" },
                unique: true,
                filter: "[IsDeleted] = 0");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DeviceCategories_ShopId_Name",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DeviceCategories_StylingId",
                table: "DeviceCategories",
                column: "StylingId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DeviceModels_ShopId",
                table: "DeviceModels",
                column: "ShopId");

            migrationBuilder.CreateIndex(
                name: "IX_DeviceModels_StylingId",
                table: "DeviceModels",
                column: "StylingId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Devices_DeviceCategoryId1",
                table: "Devices",
                column: "DeviceCategoryId1");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Devices_DeviceModelId1",
                table: "Devices",
                column: "DeviceModelId1");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_InventoryCategories_ShopId_Name",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_InventoryItems_BrandId1",
                table: "InventoryItems",
                column: "BrandId1");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_InventoryItems_DeviceCategoryId1",
                table: "InventoryItems",
                column: "DeviceCategoryId1");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_InventoryItems_DeviceModelId1",
                table: "InventoryItems",
                column: "DeviceModelId1");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_LookupValues_ShopId_Category_Value",
                table: "LookupValues",
                columns: new[] { "ShopId", "Category", "Value" },
                unique: true,
                filter: "[IsDeleted] = 0");

            migrationBuilder.CreateIndex(
                name: "IX_LookupValues_StylingId",
                table: "LookupValues",
                column: "StylingId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RepairActivities_PerformedAt",
                table: "RepairActivities",
                column: "PerformedAt");

            migrationBuilder.CreateIndex(
                name: "IX_RepairActivities_PerformedByUserId",
                table: "RepairActivities",
                column: "PerformedByUserId");

            migrationBuilder.CreateIndex(
                name: "IX_RepairActivities_RepairId",
                table: "RepairActivities",
                column: "RepairId");

            migrationBuilder.CreateIndex(
                name: "IX_RepairParts_InventoryItemId",
                table: "RepairParts",
                column: "InventoryItemId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RepairPayments_CreatedBy",
                table: "RepairPayments",
                column: "CreatedBy");

            migrationBuilder.CreateIndex(
                name: "IX_RepairPayments_PaidAt",
                table: "RepairPayments",
                column: "PaidAt");

            migrationBuilder.CreateIndex(
                name: "IX_RepairPayments_RepairId",
                table: "RepairPayments",
                column: "RepairId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RequestLogs_RequestedAtUtc",
                table: "RequestLogs",
                column: "RequestedAtUtc");

            migrationBuilder.CreateIndex(
                name: "IX_RequestLogs_ShopId",
                table: "RequestLogs",
                column: "ShopId");

            migrationBuilder.CreateIndex(
                name: "IX_RequestLogs_Source",
                table: "RequestLogs",
                column: "Source");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserPagePermissions_ShopId",
                table: "UserPagePermissions",
                column: "ShopId");

            migrationBuilder.CreateIndex(
                name: "IX_UserPagePermissions_ShopId1",
                table: "UserPagePermissions",
                column: "ShopId1");

            migrationBuilder.CreateIndex(
                name: "IX_UserPagePermissions_UserId_PageId_ShopId",
                table: "UserPagePermissions",
                columns: new[] { "UserId", "PageId", "ShopId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_UserShopRoles_RoleId",
                table: "UserShopRoles",
                column: "RoleId");
